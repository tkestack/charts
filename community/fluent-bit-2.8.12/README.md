...
```bash
$ helm install --name my-release <helm-repo>/fluent-bit
```
...
```bash
$ helm install --name my-release <helm-repo>/fluent-bit --set on_minikube=true
```
...
```bash
$ helm install --name my-release -f values.yaml <helm-repo>/fluent-bit
```
