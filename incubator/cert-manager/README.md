...
```bash
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.13.6/cert-manager.crds.yaml
```
...
$ helm install my-release --namespace cert-manager --version v1.13.6 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.13.6/cert-manager.crds.yaml
```
...
| `image.repository` | Image repository | `ccr.ccs.tencentyun.com/tke-market/cert-manager-controller` |
| `image.tag` | Image tag | `v1.13.6` |
...
| `webhook.image.repository` | Webhook image repository | `ccr.ccs.tencentyun.com/tke-market/cert-manager-webhook` |
| `webhook.image.tag` | Webhook image tag | `v1.13.6` |
...
| `cainjector.image.repository` | cainjector image repository | `ccr.ccs.tencentyun.com/tke-market/cert-manager-cainjector` |
| `cainjector.image.tag` | cainjector image tag | `v1.13.6` |
...
| `acmesolver.image.repository` | acmesolver image repository | `ccr.ccs.tencentyun.com/tke-market/cert-manager-acmesolver` |
| `acmesolver.image.tag` | acmesolver image tag | `v1.13.6` |
...
| `startupapicheck.image.repository` | startupapicheck image repository | `ccr.ccs.tencentyun.com/tke-market/cert-manager-ctl` |
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.13.6` |
