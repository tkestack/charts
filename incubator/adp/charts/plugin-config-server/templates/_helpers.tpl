{{- define "qbot.plugin_config_server.s3_storage" -}}
...
{{- define "qbot.default_icon" -}}
    {{- if eq .Values.global.components.s3.providerType "minio" -}}
        {{ .Values.global.scheme }}://{{ .Values.global.clb }}/public/plugin_files/%E6%8F%92%E4%BB%B6-%E9%BB%98%E8%AE%A4.png
    {{- else if eq .Values.global.components.s3.providerType "obs" -}}
        {{ .Values.global.scheme }}://qbot.{{ .Values.global.components.s3.obs.host }}:{{ .Values.global.components.s3.obs.port }}/public/plugin_files/%E6%8F%92%E4%BB%B6-%E9%BB%98%E8%AE%A4.png
    {{- else if eq .Values.global.components.s3.providerType "csp" -}}
        {{ .Values.global.scheme }}://{{ .Values.global.clb }}/qbot/public/plugin_files/%E6%8F%92%E4%BB%B6-%E9%BB%98%E8%AE%A4.png
    {{- else if eq .Values.global.components.s3.providerType "cos" -}}
        https://{{ .Values.global.components.s3.cos.bucket }}.cos.{{ .Values.global.components.s3.cos.region }}.myqcloud.com/qbot/public/plugin_files/%E6%8F%92%E4%BB%B6-%E9%BB%98%E8%AE%A4.png
    {{- else -}}
        https://qidian-qbot-1251316161.cos.ap-guangzhou.myqcloud.com/public/plugin_files/%E6%8F%92%E4%BB%B6-%E9%BB%98%E8%AE%A4.png
    {{- end -}}
{{- end -}}
