...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ccr.ccs.tencentyun.com/tke-market/open-webui","tag":""}` | Open WebUI image tags can be found here: https://github.com/open-webui/open-webui |
