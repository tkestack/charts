...
| `images.agent.tag` | `0.2.3-rc3` | string | Agent 镜像版本 |
...
| `images.tracker.tag` | `0.2.3-rc3` | string | Tracker 镜像版本 |
...
| `images.seedServer.tag` | `0.2.3-rc3` | string | SeedServer 镜像版本 |
...
| `images.watcher.tag` | `0.2.3-rc3` | string | Watcher 镜像版本 |
...
| `images.ntracker.tag` | `0.2.3-rc3` | string | Ntracker 镜像版本 |
...
| `images.mirrorSetup.tag` | `0.2.3-rc3` | string | Mirror Setup 镜像版本 |
...
| 参数 | 默认值 | 类型 | 说明 | 热更新 |
|------|--------|------|------|:------:|
| `agent.maxConcurrent` | `8` | int | 最大并发数 | 是 |
...
| `agent.maxBtConcurrentFlow` | `32` | int | 最大 BT 并发流 | 是 |
...
| `agent.btPortRange` | `"50001-80001"` | string | BT 端口范围 | 否 |
| `agent.maxPeerConnection` | `35` | int | 最大对等连接数 | 是 |
| `agent.requestBlockSize` | `1024` | int | 请求块大小（字节） | 否 |
...
| `agent.registryHttp` | `""` | string | HTTP 注册表列表 | 否 |
...
| `ntracker.expireTime` | `1800` | int | 数据过期时间（秒） |
