...
| `configmapTest.image.repository`               | Repository of the configmap shellcheck test image.                                                                                                                                  |  `ccr.ccs.tencentyun.com/tke-market/shellcheck`                                                                     |
...
| `sysctlImage.registry`    | sysctlImage Init container registry                                                                                                                                                                      | `ccr.ccs.tencentyun.com/tke-market`                                                                                |
