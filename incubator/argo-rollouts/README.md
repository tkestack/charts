...
| controller.image.registry | string | `"ccr.ccs.tencentyun.com"` | Registry to use |
...
| dashboard.image.registry | string | `"ccr.ccs.tencentyun.com"` | Registry to use |
...
* `ccr.ccs.tencentyun.com` is the default registry now
