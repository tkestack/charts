...
{{- define "redis.mypassword" -}}
{{- if .Values.global.redis.password -}}
  {{- .Values.global.redis.password | toString -}}
{{- else if .Values.auth.password -}}
  {{- .Values.auth.password | toString -}}
{{- else if or .Values.auth.enabled .Values.global.redis.password -}}
  {{- fail "Either global.redis.password or auth.password must be set" -}}
{{- end -}}
{{- end }}
