...
| global.image.repository | string | `"ccr.ccs.tencentyun.com/tke-market/argocd"` | If defined, a repository applied to all Argo CD deployments |
...
| dex.image.repository | string | `"ccr.ccs.tencentyun.com/tke-market/dex"` | Dex image repository |
...
| redis.image.repository | string | `"ccr.ccs.tencentyun.com/tke-market/redis"` | Redis repository |
...
| redis-ha.image.repository | string | `"ccr.ccs.tencentyun.com/tke-market/redis"` | Redis repository |
