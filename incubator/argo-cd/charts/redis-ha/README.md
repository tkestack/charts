...
| `configmapTest.image` | Image for redis-ha-configmap-test hook | object | `{"repository":"ccr.ccs.tencentyun.com/tke-market/shellcheck","tag":"v0.5.0"}` |
| `configmapTest.image.repository` | Repository of the configmap shellcheck test image. | string | `"ccr.ccs.tencentyun.com/tke-market/shellcheck"` |
...
| `image.repository` | Redis image repository | string | `"ccr.ccs.tencentyun.com/tke-market/redis"` |
...
| `haproxy.image.repository` | HAProxy Image Repository | string | `"ccr.ccs.tencentyun.com/tke-market/haproxy"` |
