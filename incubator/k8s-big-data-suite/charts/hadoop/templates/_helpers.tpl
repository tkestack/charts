...
{{- template "hdfs-k8s.name" . -}}-hadoop
{{- end -}}

{{- define "hdfs-k8s.config.fullname" -}}
{{- $fullname := include "hdfs-k8s.fullname" . -}}
{{- if contains "hadoop" $fullname -}}
{{- printf "%s" $fullname -}}
{{- else -}}
{{- printf "%s-hadoop" $fullname | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
...
{{- template "hdfs-k8s.name" . -}}-hdfs-jn
{{- end -}}
...
{{- template "hdfs-k8s.name" . -}}-hdfs-nn
{{- end -}}
...
{{- template "hdfs-k8s.name" . -}}-hdfs-dn
{{- end -}}
