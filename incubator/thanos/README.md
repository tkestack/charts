...
| `compactor.persistence.size`                 | Size of data volume                                            | `10Gi`                          |
...
| `storegateway.persistence.size`                 | Size of data volume                                            | `10Gi`                          |
...
| `ruler.persistence.size`                 | Size of data volume                                            | `10Gi`                          |
